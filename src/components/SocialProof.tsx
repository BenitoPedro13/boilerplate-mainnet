...
const SocialProof = () => {
  return (
    <section className="flex flex-row justify-center items-start pb-16 w-full h-fit bg-white lg:py-24">
      <div className="flex flex-col items-start px-4 gap-8 w-full h-fit lg:px-8 max-w-7xl">
        <p className="font-medium text-base text-center text-gray-600 w-full">
          Join 4,000+ companies already growing
        </p>
        <div className="flex flex-row items-start p-0 gap-4 w-full h-fit justify-center lg:gap-8 flex-wrap">
