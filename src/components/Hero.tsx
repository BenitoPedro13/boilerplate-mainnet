  ...
  return (
    <section className='flex flex-col items-center p-0 isolate w-full h-fit bg-white'>
      <div className="flex flex-col items-start pt-16 pb-16 gap-16 w-full">
        <div className="flex flex-row items-start pl-4 pr-4 w-full h-fit">
          <div className="flex flex-col items-start p-0 gap-8 w-full h-full">
            <div className="flex flex-col items-start p-0 gap-4 w-full h-fit">
              ...
              <p className='w-full h-fit font-normal text-lg text-gray-600'>— We’re a full-service design and development agency who specialise in simple, useful and beautiful solutions.</p>
            </div>
        ...
        <div className="flex flex-row items-center justify-center pl-4 pr-4 w-full h-fit">
          <div className="w-fit h-fit">
            <Image src={heroMobileImage} sizes='100vw' alt="Hero Ilustrative Image" />
          </div>
        </div>
      </div>
    </section>
