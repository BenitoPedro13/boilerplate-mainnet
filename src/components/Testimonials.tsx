...
const Testimonials = () => {
  return (
    <section className="flex flex-col items-center py-16 gap-16 w-full h-fit bg-gray-50">
      <div className="flex flex-col items-start px-4 gap-8 w-full h-fit">
        <div className="flex flex-col items-center p-0 gap-10 w-full h-fit">
          <div className="flex flex-col items-center gap-8 w-full h-fit">
            ...
            <h3 className="w-full h-fit font-medium text-3xl leading-[38px] text-center text-gray-900">
